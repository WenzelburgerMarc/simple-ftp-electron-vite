...
<template>
  <div
    ...
    :class="[props.item.isLogoItem ? '' : 'hover:bg-blue-400', activeRoute ? 'bg-blue-400' : '']"
    ...
    <sidebar-item-tooltip v-if="!props.item.isLogoItem && !isOpenWatcher"
                          class="tooltip"
